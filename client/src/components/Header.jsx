    ...
    return (
        <header className="flex items-center w-full p-4 md:py-2 md-px-6">
            ...
            <div
                ...
                <img src={user?.user.imageURL} className='w-12 h-12 min-w-[44px] object-cover rounded-full shadow-lg ' alt='' referrerPolicy='no-refer' />
                ...
                {isMenu && (
                    <motion.div
                        ...
                        <NavLink to={'./userProfile'}>
                            <p className='text-case text-textColor duration-150 transition-all ease-in-out hover:font-semibold'> Profile</p>

                        </NavLink>
                        <p className='text-case text-textColor  duration-150 transition-all ease-in-out hover:font-semibold'> My Favourites</p>
                            ...
                            user?.user?.role === "admin" && (
                                <>
                                    <NavLink to={"/dashboard/home"}>
                                        <p className='text-case text-textColor  duration-150 transition-all ease-in-out hover:font-semibold'> Dashboard</p>
                                    </NavLink>
                                </>
                            )
                        }

                        <p className='text-case text-textColor  duration-150 transition-all ease-in-out hover:font-semibold' onClick={logOut}>  Sign Out</p>
                    </motion.div>
                )}
